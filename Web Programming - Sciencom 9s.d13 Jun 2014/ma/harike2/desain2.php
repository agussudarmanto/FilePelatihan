	...
	<table width=800 align="center">
		...
		<tr height=450 valign="top">
			...
			<td width=200 valign="top" style="background-color:#FFB900; padding:0px;">
				<table width="100%">
					<tr>
						<td><a href="">Biro Perencanaan</a></td>
					</tr>
					<tr>
						<td><a href="">Biro Kepegawaian</a></td>
					</tr>
					<tr>
						<td><a href="">Biro Keuangan</a></td>
					</tr>
					<tr>
						<td><a href="">Biro Perlengkapan</a></td>
					</tr>
					<tr>
						<td><a href="">Biro Hukum dan Humas</a></td>
					</tr>
					<tr>
						<td><a href="">Biro Kesekretariatan Pimpinan</a></td>
					</tr>
					<tr>
						<td><a href="">Biro Umum</a></td>
					</tr>
				</table>
			</td>
			<td width="%">
